...
func GinSlog(logger *slogger.Logger, timeFormat string, utc bool) gin.HandlerFunc {
	return GinSlogWithConfig(logger, &Config{UTC: utc})
}

func GinSlogWithConfig(logger *slogger.Logger, conf *Config) gin.HandlerFunc {
...
func RecoveryWithSlog(logger *slogger.Logger, stack bool) gin.HandlerFunc {
	return func(c *gin.Context) {
		defer func() {
